...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference("Phase.count") do
      post phases_url, params: { phase: { duration_days: @phase.duration_days, name: @phase.name, objective: @phase.objective, order: @phase.order, program_id: @phase.program_id, what_to_expect: @phase.what_to_expect } }
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { duration_days: @phase.duration_days, name: @phase.name, objective: @phase.objective, order: @phase.order, program_id: @phase.program_id, what_to_expect: @phase.what_to_expect } }
